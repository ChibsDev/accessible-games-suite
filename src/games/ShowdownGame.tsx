...
function ShowdownGame() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {/* Game Area */}
      <div 
        className="bg-white rounded-lg shadow-lg p-12 min-h-96 flex items-center justify-center"
        role="application"
      ...
      >
          ...
          <div className="text-center">
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-8 text-left max-w-md mx-auto">
              ...
              <ol className="space-y-2 text-gray-700">
                ...
                <li>2. Wait for the "GO!" signal</li>
        ...
        {gameState === 'go' && (
          <div className="text-center bg-green-400 -m-12 flex items-center justify-center min-h-96 w-full rounded-lg">
            <h3 className="text-9xl font-black text-white animate-pulse">
              GO!
            </h3>
          </div>
        )}
